  ...
  return {
    ...
    createChatCompletion: async (
      ...
      if (configuration?.azure) {
        let deploymentName = configuration.azure.deploymentName
          ? configuration.azure.deploymentName
...
export const OpenAIApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createTranscription(
          file,
          model,
          prompt,
          responseFormat,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createTranslation(
          file,
          model,
          prompt,
          responseFormat,
